...
const fr: Record<string, string> = {
  ...
  "AI-guided legal matching": "Mise en relation juridique assistée par IA", "Tell us what happened.": "Expliquez-nous votre situation.", "Repere vous présente le bon avocat.": "Repere vous présente le bon avocat.",
  ...
  "How Repere works": "Comment fonctionne Repere", "Explain your situation": "Expliquez votre situation", "Review your matches": "Découvrez vos avocats", "Book securely": "Réservez en toute sécurité",
  "Repere vous aide à trouver des avocats indépendants. Repere ne fournit pas de conseil juridique.": "Repere vous aide à trouver des avocats indépendants. Repere ne fournit pas de conseil juridique.",
  ...
  "Have a relevant document?": "Vous avez un document utile ?", "Attach it now and Repere will use it to understand your situation.": "Ajoutez-le maintenant : Repere l’utilisera pour mieux comprendre votre situation.",
  ...
  "Repere assistant": "Assistant Repere", "Understanding your employment matter": "Analyse de votre dossier en droit du travail", "Private, document-aware conversation": "Conversation privée tenant compte de vos documents", "Add a document": "Ajouter un document", "Type your answer…": "Écrivez votre réponse…",
  "Change my first message": "Modifier mon premier message", "0/3 · PDF, DOCX or TXT · 8 MB max": "0/3 · PDF, DOCX ou TXT · 8 Mo maximum",
  "Repere analyse votre situation": "Repere analyse votre situation", "Send answer": "Envoyer la réponse", "Your answer": "Votre réponse", "Repere extracts relevant facts with AI. The original stays private and is shared only with the lawyer you contact.": "Repere extrait les éléments utiles avec l’IA. Le document original reste privé et n’est transmis qu’à l’avocat que vous contactez.",
  ...
  "Case brief": "Synthèse du dossier", "Review your conversation with Repere": "Relire votre conversation avec Repere", "View the brief shared with the lawyer": "Voir la synthèse transmise à l’avocat", "Your current matters": "Vos dossiers en cours", "Opening your secure workspace…": "Ouverture de votre espace sécurisé…",
  ...
  "Draft my profile with AI": "Rédiger mon profil avec l’IA", "AI profile researcher": "Recherche de profil par IA", "Let Repere prepare your first draft": "Laissez Repere préparer une première version", "Apply this draft": "Utiliser cette version", "Sources checked": "Sources consultées",
  ...
  "Privacy": "Confidentialité", "How it works": "Fonctionnement", "Clear legal help starts with the right introduction.": "Un accompagnement juridique clair commence par la bonne mise en relation.", "Return to Repere": "Retour à Repere", "Back to dashboard": "Retour au tableau de bord", "Open": "Ouvert", "Busy": "Occupé", "Unavailable": "Indisponible", "Needs review": "À examiner", "Accepted meeting": "Rendez-vous accepté", "Payment": "Paiement", "Meeting": "Rendez-vous", "Client": "Client", "People": "Participants", "Objective": "Objectif", "What happened": "Ce qui s’est passé", "What needs to happen next": "Prochaine étape", "Information still requiring your confirmation": "Informations restant à confirmer",
