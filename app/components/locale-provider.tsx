...
const fr: Record<string, string> = {
  ...
  "I could not read text from this document, so I’ll ask you for the essential facts. The original will still be shared with your lawyer.": "Je n’ai pas pu lire le texte de ce document. Je vous demanderai donc les éléments essentiels ; l’original sera tout de même transmis à votre avocat.",
